...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CardWalletSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (nonnull instancetype)initWithToken:(NSString * _Nonnull)token userId:(NSString * _Nonnull)userId partnerId:(NSString * _Nonnull)partnerId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL("_TtP13CardWalletSDK29CardWalletCredentialsProvider_")
...
SWIFT_CLASS("_TtC13CardWalletSDK13CardWalletSDK")
...
SWIFT_CLASS("_TtC13CardWalletSDK20CardWalletSDKBuilder")
...
SWIFT_CLASS("_TtC13CardWalletSDK11Environment")
...
SWIFT_CLASS("_TtC13CardWalletSDK7FSError")
