...
#ifndef CARDWALLETSDKLOYALTY_SWIFT_H
#define CARDWALLETSDKLOYALTY_SWIFT_H
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Environment * _Nonnull PREPROD;)
+ (Environment * _Nonnull)PREPROD SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
